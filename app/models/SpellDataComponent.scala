...
case class Spell(id: Int, name: String, cast_time: Int, cooldown: Int,
...
case class SpellEffect(id: Int, spell_id: Int, min_value: Int, max_value: Int,
                       stat_type: Int, effect_type: Int, school: Int) extends Serializable

case class SpellTrigger(id: Int, spell_id: Int, trigger_spell_id: Int,
